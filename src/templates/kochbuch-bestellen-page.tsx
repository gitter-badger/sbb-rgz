                ...
                <div className="field">
                  ...
                  <div className="control">
                    <input
                      className="input"
                      type={'number'}
                      name={'anzahlSchwarzschriftexemplare'}
                      onChange={handleChange}
                ...
                <div className="field">
                  ...
                  <div className="control">
                    <input
                      className="input"
                      type={'number'}
                      name={'anzahlBlindenschriftexemplare'}
                      onChange={handleChange}
...
const KochbuchBestellenPage = ({ data }: { data: any }) => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Kochbuch bestellen - Schweizerischer Blindenbund Regionalgruppe Zürich</title>
        <meta name="description" content='Auf dieser Seite können Sie das Kochbuch 2021 der Regionalgruppe Zürich des Schweizerischen Blindenbunds bestellen.' />
        <meta property="og:title" content='Kochbuch bestellen' />
        <meta property="og:description" content='Auf dieser Seite können Sie das Kochbuch 2021 der Regionalgruppe Zürich des Schweizerischen Blindenbunds bestellen.' />
        <meta property="og:url" content='https://www.rgz-blind.ch/kochbuch-bestellen/' />
      </Helmet>
