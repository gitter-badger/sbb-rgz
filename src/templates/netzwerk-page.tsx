...
export const NetzwerkPageTemplate = ({ content, contentComponent }: { content: any, contentComponent?: any }) => {
...
const NetzwerkPage = ({ data }: { data: any }) => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Netzwerk - Schweizerischer Blindenbund Regionalgruppe Zürich</title>
