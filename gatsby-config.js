...
module.exports = {
  ...
  plugins: [    
    ...
    },
    {
      ...
      options: {
        extensions: [`.mdx`, `.md`],
        plugins: [require.resolve('./plugins/gatsby-mdx-tts'), 'gatsby-remark-audio', 'gatsby-remark-embed-video', 'gatsby-remark-relative-images', 'gatsby-remark-images', `gatsby-remark-responsive-iframe`, 'gatsby-remark-copy-linked-files'],
        gatsbyRemarkPlugins: [
          {
